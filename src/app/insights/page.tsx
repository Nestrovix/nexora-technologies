  ...
  return (
    <>
      <PageIntro
        ...
        title={
          <>
            Notes from our
            <br />
            <span className="gradient-text">engineering practice</span>
          </>
        }
      ...
      <section className="pt-16 md:pt-20">
        <div className="container">
          <Link
            ...
            className="group reveal grid gap-8 border-b border-white/10 pb-12 lg:grid-cols-[1.15fr_1fr] lg:items-center lg:gap-14"
          >
            ...
            <div>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 text-[11px] font-semibold uppercase tracking-wider">
                <span className="rounded-full bg-electric-500/10 px-2.5 py-1 text-electric-400">{lead.category}</span>
              ...
              <p className="mt-4 max-w-xl text-base leading-relaxed text-ink-400">{lead.excerpt}</p>
      ...
      <section className="section pt-12">
        <div className="container">
          <p className="reveal text-[10px] font-semibold uppercase tracking-[0.2em] text-ink-500">All articles</p>
              ...
              <li key={post.slug} className="rule-row">
                <Link href={`/insights/${post.slug}`} className="group grid grid-cols-[auto_1fr_auto] items-center gap-5 py-7">
                  ...
                  <span className="min-w-0">
                    <span className="flex flex-wrap items-center gap-3 text-[11px] font-semibold uppercase tracking-wider">
                    ...
                    <span className="mt-2 block font-display text-xl font-semibold leading-snug text-ink-200 transition group-hover:text-white sm:text-2xl">
                      {post.title}
                    </span>
                  ...
                  <span className="flex items-center gap-5">
                    <span className="relative hidden h-20 w-32 shrink-0 overflow-hidden rounded-xl border border-white/10 opacity-0 transition-all duration-500 ease-premium group-hover:opacity-100 lg:block">
                      <Image src={post.image} alt="" fill loading="lazy" sizes="128px" className="object-cover" />
                    </span>
                    <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-white/10 text-ink-500 transition group-hover:border-electric-400/50 group-hover:text-electric-400">
                      <Icon name="arrow" className="h-4 w-4" />
                    </span>
                  </span>
                </Link>
